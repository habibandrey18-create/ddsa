    ...
    for attempt in range(max_attempts):
        try:
            ...
            if data and data.get("title"):
                ...
                from src.services.monitoring_service import record_parsing_attempt
                ...
                try:
                    from src.services.playwright_parser_service import get_playwright_parser
...
async def get_product_data(
    ...
    from src.utils.url_normalizer import MarketUrlInfo
    ...
    if (
        ...
        if (
            ...
            try:
                from src.utils.scraper import resolve_final_url
