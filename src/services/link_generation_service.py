        ...
        while self._running:
            try:
                ...
                try:
                    ...
                    try:
                        from src.utils.xhr_reproducer import (
...
async def _cache_product_after_link_generation(url: str, cc_link: str) -> None:
    ...
    """
    try:
        from src.models.cached_product import CachedProduct
...
async def _async_run_link_generation(
    ...
    """
    from src.utils.yandex_market_link_gen import YandexMarketLinkGen, RefLinkGenerationError
